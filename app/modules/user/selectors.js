...
export const selectUsername = (state, props) => {
  ...
  return get(entityMap, [userSchema.key, userId, 'username'], `${userId}`);
};
...
export const selectRequestState = (state, props) =>
  get(state, [REDUCER_KEY, props.userId], initialFetchState);
