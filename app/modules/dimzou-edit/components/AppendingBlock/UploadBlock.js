...
import { UserCapabilitiesContext } from '../../context';
...
function UploadBlock(props) {
        ...
        >
          ...
          <div>
            {canRetry && (
              ...
              >
                {formatMessage(uploadBlockMessages.retry)}
              </Button>
            )}
            <Button
              ...
              type="merge"
            >
              {formatMessage(uploadBlockMessages.cancel)}
            </Button>
          </div>
        </div>
      </div>
  ...
  return (
    <div
      className="dz-BlockSection dz-BlockSection_content dz-BlockSection_placeholder"
      style={props.style}
    >
      ...
      <div
        className="dz-BlockSection__wrapper"
...
UploadBlock.propTypes = {
  ...
  pivotId: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
