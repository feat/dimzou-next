...
class TailingWidget extends Component {
  handleClick = (e) => {
    ...
    const appendingCache = cache.get(
      appendingBlockKey({
    ...
    const editorState =
      appendingCache && appendingCache.html
        ? createFromHTMLWithFocus(appendingCache.html)
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="dz-ParaTailing__dropHint" />
      </div>
    );
  }
}
...
//   [DRAGGABLE_TYPE_BLOCK, NativeTypes.FILE],
//   {
...
//       if (
//         data.type === DRAGGABLE_TYPE_BLOCK &&
...
//           const creator = props.userCapabilities.canElect
//             ? props.commitMediaBlock
//             : props.submitMediaBlock;
//           // create media block;
//           creator({
//             bundleId: props.bundleId,
//             nodeId: props.nodeId,
