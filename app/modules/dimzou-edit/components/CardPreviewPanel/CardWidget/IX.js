...
import { getCardVariables } from '@/components/FeedRender/Card/IX';
...
function CardIX(props) {
  ...
  return (
    <article
      role="presentation"
      style={layoutVars}
      className="DimzouFeedCard DimzouFeedCard_IX dz-CardWidget dz-CardWidget_IXV"
      onBlur={props.onBlur}
    >
      ...
      <div className="DimzouCardFeed__inner">
